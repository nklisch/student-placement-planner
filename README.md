...
[Visit the project website](https://nklisch.github.io/student-placement-planner/) · [Download for Windows x64](https://github.com/nklisch/student-placement-planner/releases/download/v0.1.0b5/Student-Placement-Planner-0.1.0b5-Windows-x64-Setup.exe) · [Download for Apple-Silicon Mac](https://github.com/nklisch/student-placement-planner/releases/download/v0.1.0b5/Student-Placement-Planner-0.1.0b5-macOS-Apple-Silicon.dmg)
...
The Windows x64 and Apple-Silicon macOS beta is available in [v0.1.0b5](https://github.com/nklisch/student-placement-planner/releases/tag/v0.1.0b5). Both downloads are self-contained; end users do not need Python or a terminal.
